...
const mockPhotos = [
  { id: '1', label: 'Salle principale', color: 'bg-amber-200' },
  { id: '2', label: 'Terrasse extérieure', color: 'bg-green-200' },
  { id: '3', label: 'Plats signature', color: 'bg-orange-200' },
  { id: '4', label: 'Bar', color: 'bg-pink-200' },
  { id: '5', label: 'Cuisine ouverte', color: 'bg-blue-200' },
  { id: '6', label: 'Entrée', color: 'bg-purple-200' },
];
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm text-gray-500">Dashboard / Restaurants / Restaurant #{id} / Photos</p>
