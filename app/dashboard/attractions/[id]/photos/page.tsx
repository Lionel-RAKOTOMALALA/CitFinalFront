...
const mockPhotos = [
  { id: '1', label: 'Vue panoramique', color: 'bg-emerald-200' },
  { id: '2', label: 'Entrée du site', color: 'bg-teal-200' },
  { id: '3', label: 'Faune locale', color: 'bg-lime-200' },
  { id: '4', label: 'Sentier de randonnée', color: 'bg-green-200' },
  { id: '5', label: 'Point de vue', color: 'bg-cyan-200' },
  { id: '6', label: 'Coucher de soleil', color: 'bg-orange-200' },
];

export default function AttractionPhotosPage() {
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href={`/dashboard/attractions/${id}`}>
            <Button variant="outline" size="sm" className="gap-1">
              <ArrowLeft className="h-4 w-4" /> Retour
            </Button>
          </Link>
          <div>
            <p className="text-sm text-gray-500">Dashboard / Attractions / Attraction #{id} / Photos</p>
